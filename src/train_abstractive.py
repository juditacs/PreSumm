...
def validate(args, device_id, pt, step):
    ...
    tokenizer = BertTokenizer.from_pretrained('SZTAKI-HLT/hubert-base-cc', do_lower_case=True, cache_dir=args.temp_dir)
    symbols = {'BOS': tokenizer.vocab['[unused100]'], 'EOS': tokenizer.vocab['[unused1]'],
